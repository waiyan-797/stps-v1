			...
			<table class="table table-striped text-center">
				...
				<tbody>
					<tr class="" id="Initial-fee-tr">
						<td>Order Commission Fee</td>
						<td>{{ $ordercommissionFee }}</td>
						@role('admin')
							<td>
								<span class="me-2">
					...
					@role('admin')
						<tr class="d-none" id="Initial-fee-form">
							<form action="{{ route('system.update.OrderCommissionFee') }}" method="post">
								@csrf
								<td>Order Commission Fee</td>
								<td><input class="form-control-plaintext p-1" name="commissionFee" type="text" value="{{ $ordercommissionFee }}">
								</td>
								<td>
